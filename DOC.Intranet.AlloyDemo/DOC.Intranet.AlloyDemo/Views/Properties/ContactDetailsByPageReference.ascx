<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContactDetailsByPageReference.ascx.cs" Inherits="DOC.Intranet.Demo.Views.Properties.ContactDetailsByPageReference" %>
