<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ContactPagePartialTemplate.ascx.cs" Inherits="DOC.Intranet.Demo.Views.Pages.Partials.ContactPagePartialTemplate" %>
