<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="PagePartialTemplateWide.ascx.cs" Inherits="DOC.Intranet.Demo.Views.Pages.Partials.PagePartialTemplateWide" %>
