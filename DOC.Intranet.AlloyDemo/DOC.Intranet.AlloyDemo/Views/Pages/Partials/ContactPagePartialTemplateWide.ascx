<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ContactPagePartialTemplateWide.ascx.cs" Inherits="DOC.Intranet.Demo.Views.Pages.Partials.ContactPagePartialTemplateWide" %>
